    ...
    const result = await db.$queryRaw`
        ...
        (async () => {
            const {textStream} = streamText({
                    model: geminiAI('gemini-1.5-flash'),
                    prompt: `
                    You are a AI code assistant who answers questions about the codebase. Your target audience is a technical intern who is learning.
